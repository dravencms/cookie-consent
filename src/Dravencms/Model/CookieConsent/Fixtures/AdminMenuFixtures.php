...
class AdminMenuFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $adminMenuRoot = new Menu('Cookie consent', ':Admin:CookieConsent:Settings', 'fa-eur',  $this->getReference('user-acl-operation-cookieConsent-edit', \Dravencms\Model\User\Entities\AclOperation::class));
